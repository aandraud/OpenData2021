...
function url_creation(req,database){
    if(database=='vac'){
        ...
        return 'https://opendata.reseaux-energies.fr/api/records/1.0/search/?dataset=temperature-quotidienne-departementale&q='+req+'&sort=date_obs&facet=date_obs&facet=departement'
    } else {
