...
Celui-ci est disponible à l'adresse: https://opendata2021.herokuapp.com/
### Jeux de données 
...
3. 3.Nous avons également ajouté un troisième jeu de données sur les températures départementales provenant d'une autre API. (source: https://opendata.reseaux-energies.fr/explore/dataset/temperature-quotidienne-departementale/api/?disjunctive.departement )
...
- hospitalisation/dep > Pas de paramètres
- hospitalisation/dep/34 > Affichage des données
...
- dep/ > Pas de paramètres
- dep/34 > Affichage des données
...
- Création d'un schéma et vocabulaire RDF+XML
- Type de contenu renvoyé: RDF+XML, XML et JSON (par défaut)
